...
{
    public class PlayerShootState: PlayeraAttackBaseState
    {
        public PlayerShootState(AttackManager AttackManager, PlayeraAttackBaseState stateMachine, PlayerAttackParams data)
